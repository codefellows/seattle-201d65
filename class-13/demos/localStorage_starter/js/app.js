...
function handleSubmit(event){
  ...
  //Save Coffe.drinks to localStorage
  var stringyArr = JSON.stringify(Coffee.drinks);
  localStorage.setItem('drinks', stringyArr);
...
var drinksFromLocalStorage = localStorage.getItem('drinks');
var parsedDrinks = JSON.parse(drinksFromLocalStorage);
